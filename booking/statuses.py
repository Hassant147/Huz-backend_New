...
# Legacy request alias kept temporarily so older clients can still ask for the
# reported-issue subset while the canonical bucket remains ISSUES.
WORKFLOW_BUCKET_REPORTED = "REPORTED"
...
WORKFLOW_BUCKET_REQUEST_CHOICES = WORKFLOW_BUCKET_CHOICES | {
