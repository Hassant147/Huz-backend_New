...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
   <head>
      ...
      <![endif]-->
      <title>Payment Verified - Booking Processed to Partner Vendor</title>
                     ...
                     <tr>
                        <td class="sm-py-32 sm-px-24" style="mso-line-height-rule: exactly; padding: 48px; text-align: center; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                           <a href="https://hajjumrah.co" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                              <img src="https://hajjumrah.co/images/logo.png" width="155" alt="Hajj Umrah" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0;">
                           </a>
                        </td>
                     </tr>
                     <tr>
...
!
                                    ...
                                    <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; font-size: 14px; margin-bottom: 24px;">
                                       We are pleased to inform you that we have successfully checked and verified your payment for the recent booking. Your booking is now being redirected to our trusted partner vendor, who will handle your case with the utmost care and professionalism.
                                    </p>

                                    <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; font-size: 14px; margin-bottom: 24px;">
                                       Our partner vendor will process your booking promptly and provide you with all the necessary details and support. Should you have any further inquiries or need assistance, please do not hesitate to reach out to us.
                                    </p>
                                    
                                    <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; font-size: 14px; margin-bottom: 24px;">
                                       Thank you for choosing our services. We appreciate your trust and look forward to ensuring a smooth and enjoyable experience.
                                    </p>

                                   
                                    <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; font-size: 14px;  margin-bottom: 16px;">Best regards, <br><b>Hajj Umrah Team</b></p>
                                 </td>
                              </tr>
                              <tr>
