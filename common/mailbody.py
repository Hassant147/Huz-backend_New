...
<p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
   To continue with your sign-up process, please use the following One-Time Password (OTP):
</p>
<p style="padding:10px; font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 24px; display: block; font-size: 40px; line-height: 100%; background-color:#00936c; color: #fff; text-decoration: none;">
"""

verify_email_third_part = """
</p>
<p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
This OTP is essential for completing your sign-up procedures and is valid for 5 minutes. Please enter it promptly on the verification page to ensure a smooth registration process.
</p>
<p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">Thanks, <br>Hajj Umrah Team</p>
</td>
</tr>
<tr>
