...
class BusinessProfile(models.Model):
    ...
    operator_type = models.CharField(max_length=40, blank=True, null=True)
    ntn = models.CharField(max_length=50, blank=True, null=True)
    owner_cnic = models.CharField(max_length=30, blank=True, null=True)
    mobile_number = models.CharField(max_length=20, blank=True, null=True)
    official_email = models.EmailField(max_length=254, blank=True, null=True)
